...
class S3ClientTest extends BaseTest {
     ...
     * @throws Exception
     */
    public function test_aaa_the_client_creates_a_bucket() {
        $rules = [
                [
        ...
        /** @var DateTimeResult $transitionsDate */
    ...
    /**
     * @test
     * @depends test_aaa_the_client_creates_a_bucket
     * @throws Exception
     */
    public function test_aaa_the_client_uploads_and_then_copy_an_item() {
    ...
    public function test_the_client_throws_exception_if_filename_is_too_long() {
        $source = Constants::TEST_SUPPORT_FILES . '/Образование_Зависимость_от_мобильных_телефонов_Статья_24122019.docx';
    ...
    public function test_the_client_gets_the_download_link_for_an_item() {
        ...
        $this->assertContains( "This is nothing but a simple text for test the php Client for S3.", file( $link, FILE_IGNORE_NEW_LINES ) );
    }
    ...
    public function test_the_client_downloads_an_item() {
        $saveAs   = Constants::TEST_SUPPORT_FILES_DOWNLOAD . '/test(download).txt';
    ...
    public function test_the_client_gets_the_content_of_an_item() {
        ...
        $this->assertContains( "This is nothing but a simple text for test the php Client for S3.", explode( "\n", $open ) );
    }
    ...
    public function test_the_client_transfer_the_content_from_a_bucket_to_filesystem() {
        ...
        $dest   = Constants::TEST_SUPPORT_FILES_DOWNLOAD . "/";
     ...
     * @throws Exception
     */
    public function test_zzz_the_client_deletes_all_the_items() {
        $buckets = [
                $this->bucket . '-copied',
                $this->bucket . '2',
                $this->bucket,
     ...
     * @throws Exception
     */
    public function test_zzz_the_client_deletes_the_bucket() {
        $buckets = [
                $this->bucket . '-copied',
                $this->bucket . '2',
                $this->bucket,
