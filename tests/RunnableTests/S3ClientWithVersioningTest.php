...
class S3ClientWithVersioningTest extends BaseTest {
    ...
    protected function setUp(): void {
        ...
        $this->bucket = $this->base_bucket_name . '-versioning';
    }
    ...
    public function test_the_client_gets_the_download_link_for_an_item() {
        ...
        $this->assertContains( 'Here you can find activities to practise your reading skills.', file( $link, FILE_IGNORE_NEW_LINES ) );
    }
    ...
    public function test_the_client_gets_the_content_of_an_item() {
        ...
        $this->assertContains( 'Here you can find activities to practise your reading skills.', explode( "\n", $open ) );
    }
